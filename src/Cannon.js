...
function initCannon() {
    ...
    // Adding physics of the world
    {
        ...
        addBigAcademicBuildingPhysics(new CANNON.Vec3(-45, 93, -85), new CANNON.Quaternion(Math.PI / 2, 0, 0), false, ContentManager.card0Content)


        addBigAcademicBuildingPhysics(new CANNON.Vec3(32, 84, -93), new CANNON.Quaternion(Math.PI / 2, 0, 0), false, ContentManager.card1Content)
...
function addBigAcademicBuildingPhysics(position, quaternion, visuals, content) {
